    ...
    if($result)
    {
        if(mysqli_num_rows($result)==1)
        {
            ...
            if(mysqli_query($conn,$query) && sendMail($_POST['email'],$reset_token))
            {
                echo "
                <script>
                alert('Yenileme Linki Gönderildi);
        ...
        <div class="home-left">
          <div class="container">
              <div class="form-container1">
                <div class="form-title"><b>Şifreni Yenile</b></div>
                <form action="#" method="POST">
                  ...
                  <button type="submit" name="reset" class="login-btn">Linki Gönder</button>
                </form>
                <br><center>
