  ...
  if($result)
  {
    if(mysqli_num_rows($result)>0)
    {
      ...
      if($result_fetch['email']==$_POST['email'])
      {
        echo"
        <script>
        alert('Mail Zaten Giriş Yapmış Durumda);
...
$query = "INSERT INTO `registered_users` (`name`, `email`, `password`, `gender`, `state`, `district`, `verification_code`, `is_verified`) VALUES ('{$_POST['full-name']}','{$_POST['email']}','{$password}','{$_POST['gender']}','{$_POST['state']}','{$_POST['district']}', '{$verification_code}', '0')";
      ...
      {
        echo"
          <script>alert('Kayıt Başarılı,Doğrulama için mailinizi kontrol edin');
        ...
        <div class="home-left">
          <div class="container">
              <div class="form-container">
                <div class="form-title"><b>Kayıt Ol</b></div>
                <form action="#" method="POST">
                  <!-- Login Information -->
                  <div class="form-section">

                    <div class="form-field">
                      <label for="full-name">İSİM</label>
                    ...
                    <div class="form-field">
                      ...
                      <select id="gender" name="gender" required>
                        ...
                        <option value="prefer-not-to-say">BELİRTMEK İSTEMİYORUM</option>
                      </select>
                    </div>
                  ...
                  <div class="form-field">
                      <label for="confirm-password">ŞİFREYİ TEKRAR GİRİNİZ</label>
                      <input type="password" id="confirm-password" name="confirm-password" required>
                    </div>

                  <button type="submit" name="register" class="login-btn">Kayıt Ol</button>
                </form>
                <br><center>
                <div class="form-question"><h3>Zaten Giriş Yaptınız mı? <u><a href="new-login.php" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">Login Here</h3></a></u></div>
              </center>
              </div>
            </div>
        </div>
